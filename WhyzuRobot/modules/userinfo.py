...
from WhyzuRobot.__main__ import STATS, TOKEN, USER_INFO
from WhyzuRobot.modules.sql import SESSION
import WhyzuRobot.modules.sql.userinfo_sql as sql
from WhyzuRobot.modules.disable import DisableAbleCommandHandler
from WhyzuRobot.modules.sql.global_bans_sql import is_user_gbanned
from WhyzuRobot.modules.sql.afk_sql import is_afk, set_afk
from WhyzuRobot.modules.sql.users_sql import get_user_num_chats
from WhyzuRobot.modules.helper_funcs.chat_status import sudo_plus
from WhyzuRobot.modules.helper_funcs.extraction import extract_user
from WhyzuRobot import telethn
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/WhyzuSupport"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/WhyzuChannel")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/WhyzuChannel"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/WhyzuChannel")
                        ],
                    ]
