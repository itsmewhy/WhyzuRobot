...
import telegram
from WhyzuRobot import TIGERS, WOLVES, dispatcher
from WhyzuRobot.modules.disable import DisableAbleCommandHandler
from WhyzuRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from WhyzuRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from WhyzuRobot.modules.helper_funcs.string_handling import split_quotes
from WhyzuRobot.modules.log_channel import loggable
from WhyzuRobot.modules.sql import warns_sql as sql
