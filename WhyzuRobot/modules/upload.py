...
from WhyzuRobot import telethn as bot
from WhyzuRobot.modules.urluploader import download_file
from WhyzuRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @WhyzuRobot",
            )
        except Exception as e:
            traceback.print_exc()
