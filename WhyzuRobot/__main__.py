...
import sys
import traceback
import WhyzuRobot.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from WhyzuRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    LOGGER,
...
from WhyzuRobot.modules import ALL_MODULES
from WhyzuRobot.modules.helper_funcs.chat_status import is_user_admin
from WhyzuRobot.modules.helper_funcs.misc import paginate_modules
...
WHYZU_IMG = "https://telegra.ph/file/9434958755f0fd73c2b8d.jpg"

DONATE_STRING = """ Hei, senang mendengar Anda ingin menyumbang!
 Anda dapat mendukung proyek ini dengan menghubungi @Whyzu."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("WhyzuRobot.modules." + module_name)
...
def prime_about_callback(update, context):
    ...
    if query.data == "prime_":
        ...
        query.message.edit_text(
            ...
            "\nJoin My Support Group/Channel for see or report a problem on Whyzu Robot.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
        ...
        query.message.edit_text(
            text=f"<b>๏ Credis for Whyzu Robot</b>\n"
            f"\nHere Developers Making The Whyzu Robot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Whyzu", url="t.me/Whyzu"),
                    InlineKeyboardButton(text="Wazxy", url="t.me/W4zxy"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="prime_"),
