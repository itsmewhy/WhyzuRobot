...
def get_user_list(__init__, key):
    with open("{}/WhyzuRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[WhyzuRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[WhyzuRobot]')
LOGGER.info("Whyzu is starting. | An Whyzu Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/itsmewhy (t.me/Whyzu)")
...
if ENV:
    ...
    from WhyzuRobot.config import Development as Config
...
from WhyzuRobot.modules.helper_funcs.handlers import (
