...
from WhyzuRobot import aiohttpsession as aiosession
from WhyzuRobot.ex_plugins.dbfunctions import start_restart_stage
from WhyzuRobot.utils.http import get, post


async def restart(m: Message):
    if m:
        await start_restart_stage(m.chat.id, m.message_id)
    execvp(executable, [executable, "-m", "WhyzuRobot"])
