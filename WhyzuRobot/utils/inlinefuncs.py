...
from WhyzuRobot import pbot as app
from WhyzuRobot import arq
from WhyzuRobot.services.keyboard import Ikb
from WhyzuRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from WhyzuRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from WhyzuRobot.services.types import InlineQueryResultCachedDocument
from WhyzuRobot.modules.info import get_chat_info, get_user_info
from WhyzuRobot.modules.music import download_youtube_audio
from WhyzuRobot.utils.functions import test_speedtest
from WhyzuRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[ᴡʜʏᴢᴜ ʀᴏʙᴏᴛ](https://t.me/WhyzuRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Whyzu)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/9434958755f0fd73c2b8d.jpg",
            input_message_content=InputTextMessageContent(
